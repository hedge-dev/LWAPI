...
namespace app::SetEd
{
	class CClassProject : public fnd::ReferencedObject, public hh::ut::ResCommon<SResClassProjectData>
	{
	...
	public:
		CClassProject(void* pData) : ResCommon<app::SetEd::SResClassProjectData>(static_cast<SResClassProjectData*>(pData))
		{
