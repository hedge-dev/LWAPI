...
namespace app::dbg
{
	...
	public:
		...
		virtual void InitializeWire(DrawContext* in_pContext, const fnd::Geometry& in_geometry, const csl::math::Matrix34& in_transform) = 0;
		virtual void InitializeByCopying(DrawContext* in_pContext, const fnd::Geometry& in_geometry, const csl::math::Matrix34& in_transform) = 0;
		virtual void SetColor(const csl::ut::Color8& in_color) = 0;
		virtual void SetTransform(const csl::math::Matrix34& in_transform) = 0;
		virtual void Render(const DrawContext* in_pContext) = 0;
	};
}